...
public class geo extends AsyncTask<String, Void, geo.Point[]> {
    ...
    private final static String NAVER_CLIENT_ID = "u9zcc3txnl";
    private final static String NAVER_CLIENT_SECRET = "u4Mi9iOJWcFa2qlUhAo15AsZ6iTwHTxuolzTLGcW";

    private OnGeoPointListener onGeoPointListener;

    private Context context;

    public geo(Search_result context, OnGeoPointListener listener) {
